      ...
      <input type="hidden" name="currentPage" id="currentPage" value="1" />
		<div class="span6">
		  <div class="widget-box">
			  ...
			  <sf:form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/user/editpwd" enctype="multipart/form-data" commandName="vendUser" name="basic_validate" id="basic_validate" novalidate="novalidate">
