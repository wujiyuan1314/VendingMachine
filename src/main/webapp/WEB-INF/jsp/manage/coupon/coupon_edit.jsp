			  ...
			  <div class="widget-content nopadding">
			    <sf:form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/coupon/edit" enctype="multipart/form-data" commandName="vendCoupon" name="basic_validate" id="basic_validate" novalidate="novalidate">
	              ...
	              <div class="control-group">
	                ...
	                <div class="controls">
	                  <div class="input-append date datepicker">
	                      <sf:input path="startTime" class="Wdate span2" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"  readonly="true" class="span2" />
	              ...
	              <div class="control-group">
	                ...
	                <div class="controls">
	                 <div class="input-append date datepicker">
	                      <sf:input path="endTime" class="Wdate span2" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" readonly="true" class="span2" />
		                  <span class="add-on"><i class="icon-th"></i></span>
		              </div>
