...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> 
      ...
      <a href="<%=basePath1%>para/paras" class="current">参数列表</a>
    </div>
  </div>
<!--End-breadcrumbs-->
		...
		<div class="span12">
		  <div class="widget-box">
			  ...
			  <div class="widget-content nopadding">
			    <sf:form class="form-horizontal" method="post" action="add" enctype="multipart/form-data" commandName="vendPara" name="basic_validate" id="basic_validate" novalidate="novalidate">
