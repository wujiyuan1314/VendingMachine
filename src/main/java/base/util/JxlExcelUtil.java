...
import base.exception.ExcelException;
import jxl.Cell;
import jxl.Sheet;
import jxl.Workbook;
...
/**
 * @author : wujiyuan
 * @Date : 2017/6/28 16:13
 * @Comments : 利用Jxl导入导出Excel工具类
 */
public class JxlExcelUtil {
	...
	private static void setFieldValueByName(String fieldName, Object fieldValue, Object o) throws Exception {
		...
		if (field != null) {
			...
			} else if ((BigDecimal.class == fieldType) || (Double.class == fieldType)) {
	...
	public static void main(String args[]) throws ParseException{
		String fieldValue="2010/4/1";
		Date time=new SimpleDateFormat("yyyy/MM/dd").parse(fieldValue.toString());
